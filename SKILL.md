...
This repository now has registered article authority: `articles/INDEX.json` currently registers **Romance**, **Somatic Therapies**, **Inner Child Therapy**, and **Inner Signal** as working articles. For any registered article, load its registered current state/master/locks/evidence from the registry and never infer a newer master from chat, filenames, summaries, Project Sources, historical Pangram branches, or an external packet.

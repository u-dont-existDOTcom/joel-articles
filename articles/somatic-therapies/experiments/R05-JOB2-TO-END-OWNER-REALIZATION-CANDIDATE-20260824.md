# Somatic Therapies — r05 Job 2→end owner-realization reconstruction

Status: **non-authoritative candidate pending preservation + architecture + production preflight**

Scope: reader-visible Job 2 through the final prose before the existing Sky Hypnosis native embed. The registered r01 master remains authority. r04 is the immediate preservation-passing realization base; `R05-OWNER-LANGUAGE-SOURCE-20260824.md` is new higher-authority owner evidence for the changed thought route.
...
The class is much more than just TRE. They use all kinds of movements and positions along with the shaking, and I think that may be important for some people. You may need the right movement or position combined with the tremoring to find where the blockage is.
...
There are several possible ways to understand what the shaking is doing. In more mainstream language, the possibilities include rhythmic movement, reduced muscular armoring, greater awareness of bodily sensation, a possible shift away from fight-or-flight, tremor-mediated release of chronic tension, and completion of interrupted defensive impulses. Qigong describes it in terms of *qi*, or vital energy: shaking may remove energetic stagnation, increase qi circulation, dissolve stored emotional charge, and reconnect breath, body, and movement.

I think it makes the most sense here for non-verbal emotional processing, chronic freeze patterns, stress accumulating between therapy sessions, or activation that is still sitting in the body afterward. I would not treat it as a standalone treatment for severe PTSD, the main way to process trauma, something to chase catharsis with, or a replacement for skilled therapy when somebody is highly dissociative or unstable.

## The Discharge → Settle Stack

The point is not to open a lot of activation through shaking and then just walk away raw. One useful sequence is:
...
Brainspotting, as I understand it, is something you can even do yourself. I have done it myself. It is intuitive enough that you can figure it out pretty quickly, and you can feel it out without already knowing exactly what you are targeting.
...
The difference between EMDR and Brainspotting is pretty simple in my mind. EMDR is more targeted toward a specific memory or trauma, with recall procedures and a clearer thing you are working on. Brainspotting can be felt out even when you do not know exactly what the target is.
...
Sleep, substance use, medication effects, pain, nutrition, and general physiological stability can all influence how well you tolerate memory work. I have a separate [sleep guide](https://sleep.u-dont-exist.com/) for that.
...
The simplest test for me is restimulation. During the work, are you less restimulated by the trauma? And afterward, if you remember the trauma again, are you still less restimulated by it? If so, then something worked more durably than a practice that only made you feel different for a little while.

That is more useful than deciding the dose was right because you felt calm at the end of the session. Check again the next morning and over the next two or three days. What happened to sleep, irritability, dissociation, pain, compulsive processing, relationships, and ordinary functioning? Use that before deciding whether to repeat or intensify something.

# Somatic Therapies — r03 minimum-dose natural-owner candidate

Status: **non-authoritative candidate pending preservation, architecture, and production-preflight review**

Source authority: registered `articles/somatic-therapies/master.html` r01 plus the preservation-passing r02 reader-visible candidate. This pass deliberately leaves the exhausted intro, inner-child, and Job 1 generation lanes essentially intact and concentrates on the still-model-shaped material from Job 2 onward. Existing Substack native/editor objects remain invariant and must be restored byte-for-byte at their registered anchors before any HTML promotion.
...
Once the system has some basic safety, daily regulation becomes a separate problem. A deep session can be undermined when the rest of the week keeps piling activation back on.
...
The class I am linking to costs $10 per month on Skool and is the one my friend Louka took. I recommend this particular class because Louka tried many different healing and somatic modalities, including basic TRE, and nothing helped him much until he got into this one.

At this point shaking is doing a different job from the gentle early version. In Job 1 it stays exploratory. Here it can become a regular discharge practice, as long as you can still stop, orient, and settle afterward.

From a mainstream perspective, possible explanations include rhythmic movement, reduced muscular armoring, greater awareness of bodily sensation, a possible shift from fight-or-flight toward a calmer state, tremor-mediated release of chronic tension, and completion of interrupted defensive impulses. Qigong describes it differently: shaking may remove energetic stagnation, increase qi circulation, dissolve stored emotional charge, and reconnect breath, body, and movement.

A regular practice might run 10–45 minutes. It may help with non-verbal emotional processing, chronic freeze patterns, stress accumulating between therapy sessions, or activation that remains after therapy. I would not treat it as a standalone treatment for severe PTSD, the primary trauma-processing modality, a catharsis-chasing practice, or a replacement for skilled therapy when somebody is highly dissociative or unstable.
...
The reason I would not stop after the shaking is simple: you can open a lot of activation and still walk away raw.

Yin can help with the settling part, but keep it gentle, propped, and non-coercive. Long passive holds can become too evocative in trauma work. Early on, shorter holds are usually better than ambitious five-minute shapes, and you should never be encouraged to endure sensation for the sake of “release.”
...
Brainspotting uses gaze position, focused attention, bodily awareness, and therapist attunement to work with emotionally charged material.
...
Top-down cognitive work often fails when it comes too early because the body still believes the threat is happening. After regulation, discharge, and deeper processing, it can become much more useful.

This is when reframing old beliefs, building a coherent life story, separating past danger from present reality, clarifying values and boundaries, reclaiming agency, and deepening [inner-child reparenting](http://innerchild.u-dont-exist.com/) can fit. Identity formation, differentiation, forgiveness when relevant, and life direction can be worked with once enough regulation and adult capacity exist.
...
Yoga can move through several parts of the map: early for awareness, flexibility, enjoyment, and agency; after shaking to help the body settle and rebalance; or after deeper processing for stretching and reconnection. You do not need every modality or a fixed schedule.
...
Sky Hypnosis can produce lightheadedness, and Vagal Blitz is a lying-down-only practice with its own cardiovascular and mental-health cautions. Use the complete guide for the practice, begin with the least intense version that produces a useful shift, and stop when balance, orientation, or recovery becomes unreliable. Do not chase fainting or loss of consciousness.

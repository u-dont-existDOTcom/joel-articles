# Somatic Therapies — r06 Job 2→end owner-realization reconstruction

Status: **non-authoritative candidate pending preservation + architecture + production preflight**

Scope: reader-visible Job 2 through the final prose before the existing Sky Hypnosis native embed. The registered r01 master remains authority. r05 is the immediate preservation-passing realization base; `R06-OWNER-LANGUAGE-SOURCE-20260824.md` is new higher-authority owner evidence for the changed thought route; `R06-REQUESTED-FACT-CHECK-20260824.md` records only the factual checks Joel explicitly requested/materially triggered.
...
I have done a simple self-directed version of Brainspotting myself. I put up a finger and slowly moved my gaze around the field of vision, noticing whether different memories came up at different angles and how the same memory felt as my eyes moved. It is surprisingly intuitive.

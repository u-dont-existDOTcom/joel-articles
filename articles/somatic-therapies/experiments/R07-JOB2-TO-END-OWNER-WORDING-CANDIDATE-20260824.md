# Somatic Therapies — r07 Job 2→end owner-wording restoration

Status: **non-authoritative candidate pending preservation + architecture + production preflight**

Scope: reader-visible Job 2 through the final prose before the existing Sky Hypnosis native embed. Registered r01 remains article authority. r06 is the immediate preservation-passing realization base. The only new operation is minimum-edit restoration toward Joel's actual r05/r06 owner-language sources, plus the already-authorized bounded factual corrections.
...
Yin can help with the settling part, but keep it gentle, propped, and non-coercive. Long passive holds can get too evocative in trauma work. Especially early on, shorter holds are usually better than ambitious five-minute shapes. Nobody should be encouraging you to endure sensation for the sake of “release.”

---

# Job 3: Work With Diffuse, Bodily, or Hard-to-Narrate Material

Sometimes you do not actually know what you are targeting. The trauma may show up first as a sensation, impulse, emotion, image, or fragments that are hard to put into words. This is what I mean here by *subcortical* processing—not that one precise brain region contains the trauma, but that the material is showing up through the body before there is a clean verbal story.
...
And I give Brainspotting so many more points because it is democratic like EFT. You do not need any expensive expert to do it for you, although you can get one too, and it is available at any moment.
...
So a discrete traumatic event, flashback, or specific trigger network is a natural EMDR target. That includes accidents, assault memories, military trauma, distinct flashbacks, and residual triggers left after deeper somatic work. EMDR can be highly effective. It often fits after you have enough regulation, body capacity, and a way to integrate the session afterward, although a stable person working with one clear event may be ready much earlier.

Where I would not automatically start with EMDR is diffuse developmental trauma when the nervous system is still unstable. If the material is mainly bodily, pre-verbal, relational, or so diffuse that you cannot identify a clear target, Brainspotting may fit better.

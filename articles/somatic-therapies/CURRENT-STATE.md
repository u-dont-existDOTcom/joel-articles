...
Humanize Joel Rosenblum's Somatic Therapies article while preserving its arguments, recommendations, links, native media, personal material, safety functions, evidence distinctions, reparenting relationships, and practical-guide function.

Joel has granted standing publication/export permission and does not need to supply new prose. Publication is nevertheless prohibited unless the exact final headed whole-article Pangram result is **100% Human** and the fidelity, safety, citation, link, native-object, and HTML reconstruction gates all pass.
...
- The registered master remains untouched and authoritative. R02–R58 are non-authoritative editorial/detector artifacts until the normal promotion gates complete.
- Active working branch: `experiment/somatic-r17-100-human-gate-20260828`.

## Current checkpoint

### R58 routes owner-source borrowed adulthood into EMDR readiness

R58 returns exactly to the best production-complete R56 architecture, removes its final compact borrowed-adulthood unit, and places the complete exact owner-controlled guide wording immediately after `I want some access to the Nurturer and Protector first.` The adult voices have a direct antecedent; borrowed adulthood becomes a temporary external scaffold inside the existing readiness condition rather than a detached definition. The flooding/wait rule remains controlling and the text does not claim that borrowed adulthood itself makes Joel ready for EMDR.

- candidate: `experiments/R58-BORROWED-ADULTHOOD-TO-EMDR-READINESS-WHOLE-ARTICLE-CANDIDATE-20260829.md`, SHA-256 `2d6251f453a6fd1bce47d0141ebc1cc41e5b099a5b9e762d3bdcc3e1bbcae187`;
...
- exact result: `experiments/R57-FINAL-GUI-RESULT-20260829.md`;
...
The exact R57 headed check completed from one accepted action at Human `94%` / AI `6%`; an ambiguous browser-control timeout was resolved without retry from the completed dashboard, unique newest History record, and exact text binding. Every R56 segment reproduced except the final unit. The story-loop ending remains wholly AI and expands from 181 to 363 characters, raising total displayed AI from 473 to 655. Discard R57, retain R56, and close story-loop organic application at this destination.
...
- candidate: `experiments/R56-BORROWED-ADULTHOOD-AS-FINAL-SAFETY-FLOOR-WHOLE-ARTICLE-CANDIDATE-20260829.md`, SHA-256 `516c67664be7b2daf854252efe7ac1ac19ca751cdbea5b3414a4a15d6ac9828e`;
...
- exact result: `experiments/R55-FINAL-GUI-RESULT-20260829.md`;
- production completeness, preservation, claim fidelity, coherence, architecture, links, native objects, and exact extraction: PASS;
- registered article authority impact: none.

The exact R55 headed check completed from one click at Human `94%` / AI `6%`. Its Yoga region and all three R52 Human spans reproduce exactly. The late restimulation/borrowed region expands from R52's 280 to 383 characters; total displayed AI rises from 572 to 675. Discard R55, retain R52, and close live-use micro-variants at this destination.
...
- exact result: `experiments/R54-FINAL-GUI-RESULT-20260829.md`;
...
The exact R54 headed check completed from one click at Human `95%` / AI `5%`. Its Yoga region and all three R52 Human spans reproduce exactly. The conditional owner-source borrowed realization remains in the same late AI region and expands it from 280 to 331 characters; total displayed AI rises from R52's 572 to 623. Discard R54, retain R52, and close source/synonym variants at the post-restimulation destination.
...
The exact R49 headed check completed from one click at Human `88%` / AI `12%`. The late AI region remains essentially unchanged at 821 characters, and a new 255-character AI span appears in the previously Human Brainspotting/citation/EMDR boundary. Total displayed AI grows from R38's 1,115 to 1,368 characters. Discard R49 and close stronger heading separation at this Light-CBT destination.
...
The exact R46 headed check completed from one click at Human `86%` / AI `14%`. Its 1,355-character late AI segment expands 532 characters beyond R38's 823-character late segment and reaches backward through the final Brainspotting caution, citation, and complete EMDR section. The exact opening, Yoga paragraph, and 1,650-character Human ending remain stable. Discard R46 and close this Light-CBT lead realization; no synonym-level successor is eligible.
...
R25 is the next decision-useful whole candidate:

- candidate: `experiments/R25-ROUTED-BOUNDARY-WHOLE-ARTICLE-CANDIDATE-20260829.md`, SHA-256 `c178992ad1b7b5e8350c04298b34b6c78ef2ad6fd1bb41a3a9dc53fcb0688539`;
- exact headed boundary: `experiments/R25-WHOLE-ARTICLE-PANGRAM-BOUNDARY-20260829.txt`, SHA-256 `4ebcdd0f0d4d17036327ef6268bcb4ecf0f92e013ae0ffc13a3f242a4872644d`;
- size: 2,154 whitespace words / 12,229 UTF-8 bytes / 12,181 Unicode characters / terminal newline;
- preflight: `experiments/R25-ROUTED-BOUNDARY-PRESERVATION-AND-PREFLIGHT-20260829.md`;
- all three complete R21 Human/high modality inputs remain exact reader-visible substrings;
- the opening, heart loop, Somatic Experiencing/Yoga opening, between-session owner spine, and complete lived outcome story remain exact reader-visible blocks;
- the lived outcome story is moved as one unchanged unit after Light CBT to recreate the R22 Human owner boundary before Sky/Vagal without changing native-object order;
- preservation, architecture, safety/evidence, links, native objects, and exact-boundary extraction: PASS;
- ordinary links: 16/16, 13 unique, exact R24 URL multiset;
- native objects: seven inline placeholders in exact order plus the unchanged top-image invariant, 8/8 at HTML promotion;
- article authority impact: none.
...
The exact R27 boundary was submitted once in authenticated Brave/Pangram under Joel's standing direction not to interrupt for routine confirmations. Pangram 4.0 returned `Mixed`, AI `23%`, Human `77%`, with the summary `AI-generated content appears in scattered patches` and a display count of 2,165 words. History record `5f94b713-9914-4328-91bf-4ba9a4d02be1` is unambiguously bound to the frozen SHA: the live field exactly matched the local text before the click, and the five stored History segments concatenate to an exact 2,129-word match after display-only whitespace collapse.

Result artifact: `experiments/R27-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `3f2f9365` / `e461067a` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.

R27 regresses from R26 (Human `84%` → `77%`). Its Yoga/TRE rewrite absorbs the formerly Human R26 Yoga setup into a 503-character AI span. The unchanged 2,619-character middle remains Human, but the late rewrite pulls the AI boundary backward into the protected Brainspotting core and forward into the first lived-story sentence. The final 1,521 characters remain Human. Do not iterate on R27 wording; return to R26's three Human segments and change only its two AI regions through structural placement or higher-authority source recovery. No completed whole hash may be repeated.

R28 is the next decision-useful whole candidate:
...
The exact R30 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The clean field exactly matched the frozen SHA, plagiarism was off, and the single click resolved without ambiguity. Pangram 4.0 returned `Mixed`, AI `16%`, Human `84%`, with 2,121 display words and the summary `AI-generated content appears in scattered patches`. History record `09ae2ee4-fa96-4900-b49a-37737bec525c` is unambiguously bound to the frozen text by exact pre-click equality and exact 2,086-word History concatenation after display-only whitespace collapse.

Result artifact: `experiments/R30-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `80b28d7b` / `dca607c1` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.
...
R32 recovers one natural readiness function owner and leaves aftercare, Light CBT, borrowed adulthood, every Human span, and the complete early region fixed.

The exact R32 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The clean field exactly matched the frozen SHA, plagiarism was off, and the single click resolved without ambiguity. Pangram 4.0 returned `Mixed`, AI `11%`, Human `89%`, with 2,132 display words and the summary `AI-generated content appears in scattered patches`. History record `0ef2606a-dda3-40f1-84f2-2b8bf637f5db` is unambiguously bound to the frozen text by exact pre-click equality and exact 2,098-word History concatenation after display-only whitespace collapse.

Result artifact: `experiments/R32-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `5443f06b` / `77c70470` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.
...
R33 isolates a different natural late function owner after R32's readiness source recovery failed.

The exact R33 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The field exactly matched the frozen SHA and plagiarism was off. Browser control timed out while dispatching the single action, so duplicate defense prohibited a retry. The result dialog and unique newest History row proved the first action had succeeded. Pangram 4.0 returned `Mixed`, AI `23%`, Human `77%`, with 2,178 display words and the summary `AI-generated content appears in scattered patches`. History record `6dd2b1ff-ef72-4dff-a23c-7fea57ce2ae0` is unambiguously bound to the frozen text by exact pre-click equality and exact 2,144-word History concatenation after display-only whitespace collapse.

Result artifact: `experiments/R33-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `24722312` / `383baeda` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.
...
R35 isolates paragraph stacking at the exact early Human/AI boundary without touching the successful R31 late region.

The exact R35 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The clean field exactly matched the frozen SHA, plagiarism was off, and the single click resolved without ambiguity. Pangram 4.0 returned `Mixed`, AI `11%`, Human `89%`, with 2,120 display words and the summary `AI-generated content appears in scattered patches`. History record `506bca12-0f23-4f31-8f7f-a5c59c678fd4` is unambiguously bound to the frozen text by exact pre-click equality and exact 2,086-word History concatenation after display-only whitespace collapse.

Result artifact: `experiments/R35-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `c80e8a10` / `6de6b8f6` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.
...
The exact R36 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The clean field exactly matched the frozen SHA and plagiarism was off. Browser control timed out only after the accepted click, disabled control, and visible result; no retry occurred. Pangram 4.0 returned `Mixed`, AI `11%`, Human `89%`, with 2,117 display words and the summary `AI-generated content appears in scattered patches`. Unique History record `9aab48f3-2ad2-49cf-8df6-0f950442f5c9` is exactly bound to the frozen text by the pre-click equality and exact 2,082-word History concatenation after display-only whitespace collapse.

Result artifact: `experiments/R36-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `ad6ba2f9` / `5e158876` on `u-dont-existDOTcom/pangram-humanization-lab@automation/pangram-fixed-batch`.
...
The exact R38 boundary was submitted once in the correct signed-in `2nd gpt` Brave profile. The clean field exactly matched the frozen SHA and plagiarism was off. Browser control timed out only after acceptance and no retry occurred. Pangram 4.0 returned `Mostly Human`, AI `10%`, Human `90%`, with 2,117 display words. The History table classifies the record as Human, but Joel's publication gate requires an exact 100% Human score, so it remains ineligible. Unique History record `f81c1707-eaac-4eed-b2aa-3f5ac8eb50fd` is exactly bound to the frozen 2,082-word text.

Result artifact: `experiments/R38-FINAL-GUI-RESULT-20260829.md`. Durable lab reservation/result commits: `3277e219` / `28dfc15e`.

R38 is the new best completed production baseline at Human `90%`. The entire moved TRE safety paragraph composes inside a 3,923-character Human region. The early AI region shrinks from 409 characters in R36 to the 292-character Yoga paragraph alone; the 823-character late AI region and 1,650-character Human ending reproduce exactly. Freeze the route and all three Human regions.

## Completed

- R17 isolated the exact Human Somatic Experiencing spine and closed the model-only rewrite lane.
- R18 and R19 localized the red technical/closure interactions without repeating controls.
...
- R45 final headed GUI completed once at Human `79%` / AI `21%`; exact History binding passed, but the claim-complete late rewrite pulled AI backward into Human/high Brainspotting and forward into the lived outcome. R45 is discarded, broad late thought-development rewriting is closed, and its hash is blocked from repetition.
...
- R45 final headed GUI: Mixed; AI `21%`, Human `79%`; exact History report `b5969146-b139-40c5-80e7-8cba769ed0b4`; one completed call, zero retries or duplicates; the broad late rewrite increased displayed AI surface by `1,444` characters and absorbed Brainspotting plus the first lived-outcome sentence.
...
R27 demonstrates that a broader direct first-person rewrite is not the next route. It reduces the opening Human segment to 4,997 characters, expands Yoga/TRE to 503 AI-marked characters, preserves the older 2,619-character middle, expands the late AI run to 2,241 characters, and reduces the final Human segment to 1,521 characters. Return to the R26 surface and test structural distribution or exact source recovery inside only R26's two AI spans.

### R17–R19: model-realized technical prose and compact editorial closure fail

- Free conversational reconstructions and corpus-skeleton transfer did not generalize.
- Somatic Experiencing isolated a 141-word Human/high prefix; compact method/timing tails failed.
- R18 Yoga, gentle shaking, Brainspotting, EMDR, Light CBT, and Sky all returned AI `1.0`.
- R19 single-cluster additions still failed: Yoga AI/AI; gentle shaking AI/Mixed; Sky Mixed/AI. Yoga and Sky reached their 6/6 caps.
- Durable interpretation: stacking matters, but compact technical/editorial realization can independently flip a Human boundary. Phrase hunting and synonym replacement are not authorized.

### R20–R21: direct spontaneous owner syntax succeeds

R20 exact owner-source results:

- raw Brainspotting: Human/high, Human `1.0`;
- raw Brainspotting/EMDR contrast: Human/high, Human `1.0`;
- raw shaking/Qigong explanation: Human/high, Human `1.0`;
- polished published Protector block: AI/high, AI `1.0`;
- polished owner-guide witness/borrowed block: AI/high, AI `1.0`;
- polished owner-guide self-hypnosis safety block: AI/high, AI `1.0`.

R21 minimum factual/publication normalizations all remained Human/high at Human `1.0`:

- Brainspotting SHA `36bd9579cb55743d5f1f095eba878fa9048d2f68ebf4acf28c8c03182bf75229`;
- EMDR SHA `dcc20d2065d6d42486d3686cb199b2a72d446bcad1e3da419cee4990d76ede51`;
- Shaking SHA `2f76511812266c8a6f52b368ad9f2bc35648aa1b65b716f989df7aa6da4af13a`.

Production lesson: recover spontaneous owner syntax, preserve its uneven thought development and lived specificity, and correct only what factual accuracy/safety requires. Do not simulate quirks or convert the thought into a balanced taxonomy, checklist, or tidy explanatory closure.
...
- exact R08 adult/child-trust paragraph and the Human opening through Nurturer/Protector naming; R25 re-realizes only the repeatedly AI-marked action/self-hypnosis tail;
- exact owner heart-to-solar-plexus loop;
- exact R21 Brainspotting, EMDR, and Shaking sections;
- Human/high housemate/self-Brainspotting immediate-restimulation outcome span;
- Professor Baby Sheep, head shaving/loveyhuasca, Louka, natural/psychedelic shaking, neurological de-armoring, and other locked owner anchors.
...
R32 completed from one click beginning at `2026-08-29T15:41:26.824Z`; its unique History record is `https://www.pangram.com/history?history=0ef2606a-dda3-40f1-84f2-2b8bf637f5db`. The plagiarism option remained off. There is no pending or ambiguous R32 submission. Do not repeat SHA `310943f17192702bcdae5f23c49263f43e5e857cab09d1199ad481743438c045`.
...
R35 completed from one click beginning at `2026-08-29T16:10:58.164Z`; its unique History record is `https://www.pangram.com/history?history=506bca12-0f23-4f31-8f7f-a5c59c678fd4`. The plagiarism option remained off. There is no pending or ambiguous R35 submission. Do not repeat SHA `66adc0158b311f819b2ce96d2918a07aa80be3c6b31d4e0a768f68bd589bbc6d`.
...
R41's one submit action began at `2026-08-29T17:15:49.327Z`; its unique History record is `https://www.pangram.com/history?history=3cb1faf5-6677-4adb-adf0-9ed4e037afc9`. The dashboard completed normally, the plagiarism option remained off, and exact stored-text binding passed. There is no pending or ambiguous R41 submission. Do not repeat SHA `920d58e0e342552c2c6e73ddb0436afb418c4ca214fcd3cc7160bc699a4d473a`.
...
R45's one submit action began at `2026-08-29T17:59:27.149Z`; its unique History record is `https://www.pangram.com/history?history=b5969146-b139-40c5-80e7-8cba769ed0b4`. The dashboard completed normally, the plagiarism option remained off, and exact two-page stored-text binding passed. There is no pending or ambiguous R45 submission. Do not repeat SHA `25d17226967b3d097919c6ba280141fc25295abc78dd030eb80f599e47a6c9ed`.
...
R54's one submit action began at `2026-08-29T19:15:55.755Z`; its unique History record is `https://www.pangram.com/history?history=a43568bc-e345-4611-988a-97b1f743af60`. The dashboard completed normally, the plagiarism option remained off, and exact two-page stored-text binding passed. There is no pending or ambiguous R54 submission. Do not repeat SHA `6b343819251d8af107333d6986846d2620a592e1d578970101997decbeccdf73`.
...
- Discard R45 and return exactly to R38. The claim-complete thought-development rewrite expanded the late interaction backward into Brainspotting and forward into the lived outcome.

...
- Owner-lock manifests preserve exact passages and protected rhetorical functions. Never alter or remove a lock to make a candidate pass validation; obtain an owner decision.

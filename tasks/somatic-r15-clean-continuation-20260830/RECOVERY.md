...
Registered working master remains unchanged:

`articles/somatic-therapies/master.html`

SHA-256:

`1e7e94717f40e7a4de77974a896f600a1bf2769d9c1846cbe84275e136ff5202`

No current experiment is registered article authority.

## Clean R15 detector baseline

Exact R15 whole-document boundary:
...
That result remains the clean recovery baseline. It does not satisfy the owner outcome.

## Mandatory quarantine

- R16 is excluded because it begins the forbidden Cancer-corpus grammatical-route method.
- R17–R58 are owner-stopped and quarantined as production prose.

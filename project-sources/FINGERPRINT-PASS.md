...
- whether the coherence architecture card was completed before prose;
...
Critical process failures include transcript collage, clause mosaic, unexplained verbatim dependency, architecture-after-prose, question-order drafting, source-role symmetry, proposition-route substitution, question-frame contamination, wrong-thought preservation, dead recap, score-over-owner, false P1 detector fragility, sentence-color literalism, boundary amnesia, candidate-regression drift, process-provenance leakage, and detector-approved inaccuracy.

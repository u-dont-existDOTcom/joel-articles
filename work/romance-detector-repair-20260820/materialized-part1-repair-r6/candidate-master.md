...
Kim Anami calls the sexual current between encounters [“the simmer”](https://kimanami.com/meet-another-well-fked-man/). If we supposedly want each other but only show it when somebody officially initiates sex, I think something is already going wrong.

...
SCRIPT = WORK / "apply_part1_repair_r4.py"
...
class RomancePart1SelectiveResidualMaterializerTests(unittest.TestCase):
    def test_materializes_two_selective_repairs_and_preserves_part2(self) -> None:

...
| Transfer payload | one-paste rich HTML |  | exact final archival HTML | confirmed wrapper/object conversions | transfer conversion |  |  |
| Substack helper | local Opera helper |  | transfer payload | immediate ClipboardItem + silent fallback | compatibility regression | real Substack paste |  |
